...
public class MainPage_Dashboard {
	...
	public By edit_page_button=By.cssSelector(".edit[href*=openAddPage]");
	...
	public By welcome_link=By.cssSelector("a[href='#Welcome']");
	...
	public By data_profiles_link=By.cssSelector("a[href='profiles.jsp']");
}
